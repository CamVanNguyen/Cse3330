...
ALTER TABLE ITEM ADD CONSTRAINT FK_RECCOMEND_ITEM_recommended_id FOREIGN KEY (recommended_id) REFERENCES ITEM(item_id)  ON UPDATE CASCADE ON DELETE RESTRICT;
ALTER TABLE ITEM ADD CONSTRAINT FK_ITEM_LIBUSER_user_id FOREIGN KEY (user_id) REFERENCES LIBUSER(user_id)  ON UPDATE CASCADE ON DELETE RESTRICT;
ALTER TABLE ITEM ADD CONSTRAINT FK_ITEM_PERSON_publisher_id FOREIGN KEY (publisher_id) REFERENCES PERSON(person_id)  ON UPDATE CASCADE ON DELETE RESTRICT;
ALTER TABLE ITEM ADD CONSTRAINT FK_ITEM_GENRE_genre_id FOREIGN KEY (genre_id) REFERENCES GENRE(genre_id)  ON UPDATE CASCADE ON DELETE RESTRICT;
